...
for dataset in datasets:
  if dataset.startswith('+'):
    ...
    if submitLocal or 'user' in dataset:
      ...
      if isUL:
        if 'Run2017' in dataset :   os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions17/13TeV/Legacy_2017/" +       getJSON(isUL, True, False)
        elif 'Run2018' in dataset : os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions18/13TeV/Legacy_2018/" +   getJSON(isUL, False, True)
        else :                      os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions16/13TeV/Legacy_2016/" + getJSON(isUL, False, False)
      else: 
        if 'Run2017' in dataset :   os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions17/13TeV/ReReco/" +       getJSON(isUL, True, False)
        elif 'Run2018' in dataset : os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions18/13TeV/ReReco/" +   getJSON(isUL, False, True)
        else :                      os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions16/13TeV/ReReco/Final/" + getJSON(isUL, False, False)
