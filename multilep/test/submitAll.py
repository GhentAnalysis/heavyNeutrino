...
for dataset in datasets:
    ...
    if 'pnfs' in dataset or 'user' in dataset or submitLocal == "local":
        ...
        if 'Run2017' in dataset: os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions17/13TeV/PromptReco/Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt"
