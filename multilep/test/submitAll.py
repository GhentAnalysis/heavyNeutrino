...
productionLabel = os.path.basename(datasetsFile.split('.')[0]) + 'displ_firststep_wg'                                            # Label to keep track of the tuple version (is taken from the name of the above input file)
outDir          = '/user/' + os.environ['USER'] + '/public/heavyNeutrino/displ_firststep'                                 # Output directory in case of local submission
