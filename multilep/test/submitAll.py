...
for dataset in datasets:
  if dataset.startswith('+'):
    ...
    if submitLocal or 'user' in dataset:
      ...
      if 'Run2017' in dataset :   os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions17/13TeV/ReReco/" +       getJSON(True, False)
      elif 'Run2018' in dataset : os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions18/13TeV/ReReco/" +   getJSON(False, True)
      else :                      os.environ['CRAB_LUMIMASK'] = "https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions16/13TeV/ReReco/Final/" + getJSON(False, False)
