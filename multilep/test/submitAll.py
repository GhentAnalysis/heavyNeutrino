...
productionLabel = os.path.basename(datasetsFile.split('.')[0]) + 'displ_firststep'                                            # Label to keep track of the tuple version (is taken from the name of the above input file)
