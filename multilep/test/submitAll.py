...
productionLabel = os.path.basename(datasetsFile.split('/')[-1].split('.')[0])+'_10_01'                             # Label to keep track of the tuple version (is taken from the name of the above input file)
