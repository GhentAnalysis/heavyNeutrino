...
process.blackJackAndHookers = cms.EDAnalyzer('multilep',
  ...
  electronsEffectiveAreasRelIso2016  = cms.FileInPath('RecoEgamma/ElectronIdentification/data/Summer16/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_94X.txt'), #TODO: fix this is the master branch, for some reason (probably because of ttH syncing) the old effective areas slipped back into here; it seems we need a separate ttH
