...
def checkCrabDir(dir):
  ...
  if not 'KILLED' in system('crab status -d ' + dir):
    ...
    for job in jobs:
      ...
      if job['Exit code'] in ['-1','65','83', '86', '97', '60311','60318','8001','8002','8012','8022','8021','8020','8028','134','135','8004','-15','139','60317','60307','60302','10030','10031','10034','10040','50115','50664','50660','50662','8010','7002','50665', '60324']: jobsToResubmit.append(job['Job'])
