...
for job in jobs:
  ...
  if job['Exit code'] in ['-1','83','60311','60318','8001','8002','8022','8021','8020','8028','134','135','8004','-15','139','60317','60307','60302','10030','10031','10034','10040','50115','50664','50660','50662']: jobsToResubmit.append(job['Job'])
...
if len(jobsToResubmit) > 0:
  ...
  else:             os.system("crab resubmit --jobids=" + jobsToCrabList(jobsToResubmit) + (' --maxmemory=4000' if raiseMemoryLimit else '') + " --siteblacklist=T2_US_Wisconsin,T2_US_Vanderbilt,T2_CH_CERN,T2_BE_IIHE")
