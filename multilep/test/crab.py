...
requestName = requestName.replace('RunIIFall17MiniAODv2-PU2017RECOSIMstep_12Apr2018_94X_mc2017_realistic_v14', 'MiniAOD2017v2')
...
config.Data.unitsPerJob                = 1 if 'SIM' in dataset else 30
