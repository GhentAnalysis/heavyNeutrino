...
double LeptonAnalyzer::leptonMvaVal(const pat::Muon& muon, LeptonMvaHelper* mvaHelper){
    return mvaHelper->leptonMvaMuon(_lPt[_nL],
            ...
            multilepAnalyzer->is2016() ? _miniIsoCharged_80X[_nL] : _miniIsoCharged[_nL],
            multilepAnalyzer->is2016() ? _miniIso_80X[_nL] - _miniIsoCharged_80X[_nL] : _miniIso[_nL] - _miniIsoCharged[_nL],
            _ptRel[_nL],
            _ptRatio[_nL],
...
double LeptonAnalyzer::leptonMvaVal(const pat::Electron& electron, LeptonMvaHelper* mvaHelper){
    return mvaHelper->leptonMvaElectron(_lPt[_nL],
            _lEta[_nL],
            _selectedTrackMult[_nL],
            multilepAnalyzer->is2016() ? _miniIsoCharged_Spring15[_nL] : _miniIsoCharged[_nL],
            multilepAnalyzer->is2016() ? _miniIso_Spring15[_nL] - _miniIsoCharged_Spring15[_nL] : _miniIso[_nL] - _miniIsoCharged[_nL],
            _ptRel[_nL],
